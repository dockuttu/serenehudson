...
DEVICE_LOGOS = {"harmony-bio-boost":["harmony-bio-boost"],"opus-plasma":["opus-plasma"],"alma-ted":["alma-ted"],"alma-duo":["alma-duo"],"botox":["botox-cosmetic","app-platinum"],"fillers":["juvederm","app-platinum"],"lip-filler":["juvederm","app-platinum"],"cheek-filler":["juvederm","app-platinum"],"under-eye-filler":["juvederm","app-platinum"],"jawline-filler":["juvederm","app-platinum"],"chin-filler":["juvederm","app-platinum"],"skinvive":["skinvive","app-platinum"],"kybella":["kybella","app-platinum"],"diamondglow":["diamondglow","app-platinum"]}  # slug -> Alma logo keys shown as a "Powered by" badge under the hero
...
<section class="svc-hero">
  <div class="wrap">
    ...
    <div class="svc-hero-grid">
      ...
      <div class="svc-hero-media">{hero_seal}<img src="/img/{hero_img}.jpg" alt="{h1} at Serene Med Spa in Hudson, Ohio" width="800" height="800"></div>
    </div>
  </div>
</section>
