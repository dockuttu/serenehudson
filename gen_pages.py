...
DEVICE_LOGOS = {"harmony-bio-boost":["harmony-bio-boost"],"opus-plasma":["opus-plasma"],"alma-ted":["alma-ted"],"alma-duo":["alma-duo"]}  # slug -> Alma logo keys shown as a "Powered by" badge under the hero
