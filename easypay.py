...
.ep-word{font-size:1.7rem;font-weight:700;letter-spacing:-.01em;line-height:34px;color:#1f5f56}
...
.ep-card .ep-word{font-size:2rem;line-height:40px;margin-bottom:14px;display:block}
