...
.tech-row{display:flex;flex-wrap:wrap;justify-content:center;align-items:center;gap:18px 44px}
.tech-row img{width:auto;display:block;opacity:.88;transition:opacity .3s}
.tech-row a:hover img{opacity:1}
.device-badge{display:inline-flex;align-items:center;gap:14px;margin:-10px 0 26px;padding:10px 16px;border:1px solid var(--blush-deep);border-radius:999px;background:#fff}
